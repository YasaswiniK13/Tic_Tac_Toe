...
class TicTacToe():
    ...
    def edit_square(self, grid_coord):
        #Convert grid cooardinates (eg: '1A') to list indices and updates the grid with the player's symbol if the square is empty.
    ...
    def did_win(self, player_symbol):
        #checks if the given player symbol has won the game by checking all possible winning combinations.
